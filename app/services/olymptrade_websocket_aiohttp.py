...
class OlympTradeWebSocketClientAioHttp:
    ...
    async def connect(self) -> bool:
        """Connect to OlympTrade WebSocket using aiohttp"""
        try:
            logger.info("Connecting to OlympTrade WebSocket with aiohttp...")
    ...
    async def _handle_messages(self):
        ...
        try:
            while self._is_running and self.websocket and not self.websocket.closed:
                try:
    ...
    async def _send_initial_subscriptions(self):
        ...
        try:
            ...
            await self.websocket.send_str(json.dumps(general_sub))
    ...
    async def subscribe_to_candlesticks(self, currency_pair: str) -> bool:
        ...
        try:
            ...
            await self.websocket.send_str(json.dumps(alt_subscribe_msg))
    ...
    async def get_historical_candles(self, currency_pair: str, count: int, end_time: Optional[datetime] = None) -> List[CandlestickData]:
        ...
        try:
            ...
            await self.websocket.send_str(json.dumps(history_request))
    ...
    async def send_ping(self):
        ...
        if self.is_connected:
            try:
                ...
                await self.websocket.send_str(json.dumps(ping_msg))
            except Exception as e:
